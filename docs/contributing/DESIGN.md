...
The Platform SDK should be designed to enhance the productivity of developers connecting to Workiva services. Other qualities (such as completeness, extensibility, and performance) are important but secondary. Productivity is achieved by adhering to the principles described below:
